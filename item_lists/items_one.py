...
def choose_early_item(item_choice, x, y):
	...
	generic_pants      =  280
	fireball_scroll    =  281
	lightning_scroll   =  282
	confusion_scroll   =  283
	...
	if item_choice == 'healing_potion':
		...
		item = Entity(x, y, healing_potion, libtcod.violet, 'Healing Potion', render_order=RenderOrder.ITEM,
					  item=item_component)
		...
		item = Entity(x, y, generic_sword, libtcod.brass, 'Broken Iron Sword', render_order=RenderOrder.ITEM,
		...
		item = Entity(x, y, generic_bow, libtcod.sepia, 'Flimsy Wooden Bow', render_order=RenderOrder.ITEM,
					  equippable=equippable_component)
		...
		item = Entity(x, y, generic_shield, libtcod.darker_orange, 'Cracked Wooden Board', render_order=RenderOrder.ITEM,
					  equippable=equippable_component)
		...
		item = Entity(x, y, generic_tunic, libtcod.darker_sepia, 'Dirty Leather Tunic', render_order=RenderOrder.ITEM,
					  equippable=equippable_component)
		...
		item = Entity(x, y, generic_pants, libtcod.darker_sepia, 'Dirty Leather Pants', render_order=RenderOrder.ITEM,
					  equippable=equippable_component)
		item.item.description = ("It smells something awful and provides next to no protection.")
		...
		item = Entity(x, y, fireball_scroll, libtcod.red, 'Fireball Scroll', render_order=RenderOrder.ITEM,
					  item=item_component)
		...
		item = Entity(x, y, confusion_scroll, libtcod.light_pink, 'Confusion Scroll', render_order=RenderOrder.ITEM,
					  item=item_component)
		...
		item = Entity(x, y, lightning_scroll, libtcod.yellow, 'Lightning Scroll', render_order=RenderOrder.ITEM,
					  item=item_component)
