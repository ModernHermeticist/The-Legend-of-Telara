...
def choose_easy_monster(monster_choice, dungeon_level, x, y):
	if monster_choice == 'gnoll':
		...
		class_component = Fighter(hp=20+(2*dungeon_level-1), mp=0, defense=0+dungeon_level,
		...
		class_component = Fighter(hp=50+(2*dungeon_level-1), mp=0, defense=1+dungeon_level, 
									power=6+(2*dungeon_level-1), xp=100+(5*(dungeon_level-1)))
		ai_component = BasicMonster()
